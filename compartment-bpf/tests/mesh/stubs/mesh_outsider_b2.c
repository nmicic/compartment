...
// mesh_outsider_b2 — Set B outsider stub b2 (declared in NO actor group) in the exec-domain mesh.
//
// Compiled with -DSTUB_ID=b2; the per-binary stub_id_tag string ensures
