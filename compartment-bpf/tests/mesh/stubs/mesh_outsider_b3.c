...
// mesh_outsider_b3 — Set B outsider stub b3 (declared in NO actor group) in the exec-domain mesh.
//
// Compiled with -DSTUB_ID=b3; the per-binary stub_id_tag string ensures
