...
// mesh_outsider_b1 — Set B outsider stub b1 (declared in NO actor group) in the exec-domain mesh.
//
// Compiled with -DSTUB_ID=b1; the per-binary stub_id_tag string ensures
