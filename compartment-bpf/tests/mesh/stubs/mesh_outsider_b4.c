...
// mesh_outsider_b4 — Set B outsider stub b4 (declared in NO actor group) in the exec-domain mesh.
//
// Compiled with -DSTUB_ID=b4; the per-binary stub_id_tag string ensures
